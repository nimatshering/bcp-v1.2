...
class ClimateObservedReport extends Component
{
    public $station, $parameter, $start_yr, $end_yr, $statistic, $month, $stationlist, $parameterlist;
    ...
    */ 
    public function render()
    {
        ...
        return view('livewire.reports.climate-observed-report', compact('statistics'));
    }
    ...
    */ 
    ...
    |--------------------------------------------------------------------------
    */
    public function fetchClimateObservedData(Request $request)
    {
      $start_yr = $request->input('start_year');
      $end_yr = $request->input('end_year');
      $parameter = $request->input('parameter');
      $station = $request->input('station');
      $climate_line_data = ClimateObservedData::select('id','date_of_reading', 'data')->where('station_id',$station)
  ...
  |--------------------------------------------------------------------------
  */
  public function fetchClimateObservedDataBoxPlot(Request $request)
  {
      $start_yr = $request->input('start_year');
      $end_yr = $request->input('end_year');
      $parameter = $request->input('parameter');
      ...
      $climatedata = ClimateObservedData::select('id','date_of_reading', 'data')
  ...
  |--------------------------------------------------------------------------
  */
  public function fetchClimateObservedDataRegression(Request $request)
  {
      $start_yr = $request->input('start_year');
      $end_yr = $request->input('end_year');
      $parameter = $request->input('parameter');
