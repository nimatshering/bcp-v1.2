...
class ClimateReanalyzedReport extends Component
{
    public $station, $grid, $parameter, $start_yr, $end_yr, $statistic, $month, $stationlist, $parameterlist;
    ...
    */ 
    public function render()
    {
        ...
        return view('livewire.reports.climate-reanalyzed-report', compact('statistics'));
    }
    ...
    */ 
    ...
    |--------------------------------------------------------------------------
    */
    public function fetchClimateReanalyzedData(Request $request)
    {
      $start_yr = $request->input('start_year');
      $end_yr = $request->input('end_year');
      $parameter = $request->input('parameter');
      $station = $request->input('station');
      $climate_line_data = ClimateReanalyzedData::select('id','date_of_reading', 'data')->where('station_id',$station)
                                                  ->where('parameter_id',$parameter)
                                                  //->whereBetween('date_of_reading', [$start_yr, $end_yr])
  ...
  /*--------------------------------------------------------------------------
  | fetchClimateObservedDataBoxPlot
  |--------------------------------------------------------------------------
  */
  public function fetchClimateReanalyzedDataBoxPlot(Request $request)
  {
      $start_yr = $request->input('start_year');
      $end_yr = $request->input('end_year');
      $parameter = $request->input('parameter');
      ...
      $climatedata = ClimateReanalyzedData::select('id','date_of_reading', 'data')
  ...
  |--------------------------------------------------------------------------
  */
  public function fetchClimateReanalyzedDataRegression(Request $request)
  {
      $start_yr = $request->input('start_year');
      $end_yr = $request->input('end_year');
      $parameter = $request->input('parameter');
