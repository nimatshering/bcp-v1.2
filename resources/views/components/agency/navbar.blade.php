<!-- main navigation-->
  <nav class="flex flex-wrap items-center justify-between w-full px-2 py-3 bg-gray-50 shadow navbar-expand-lg">
    <div class="container flex items-center justify-between mx-auto">
      <a href="{{ route('admin.dashboard')}}">
        <div class="flex flex-wrap space-x-4 items-center">
          <h2 class="text-xl md:text-2xl font-semibold leading-8 tracking-tight text-gray-800 pl-6">
            National Environment Commission
          </h2>
          <p class="font-dzongkha mt-2 text-xl leading-8 tracking-tight text-gray-800 md:text-2xl">
