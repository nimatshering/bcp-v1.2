<div>
  ...
  <div class="mb-10">
   <div class="py-2 w-8/12">
      <div class="mt-2">
        <div class="w-full">
            <x-jet-input id="title" type="text" placeholder="Document Name" class="form-control mt-1 block w-full" wire:model.defer="projectdocument.title" />
            <x-jet-input-error for="projectdocument.title"/>
        </div>
    ...
    <div class="w-8/12 shadow px-4 py-2">
      ...
      @foreach ($projectdocuments as $item)
