<div>
  ...
  <div class="mb-10">
   <div class="py-2 w-8/12">
      <div class="mt-2">
        <div class="w-full">
            <x-jet-input id="title" type="text" placeholder="Document Title" class="form-control mt-1 block w-full" wire:model.defer="researchstudydocument.title" />
            <x-jet-input-error for="researchstudydocument.title"/>
        </div>
    ...
    <div class="w-8/12 shadow px-4 py-2">
      ...
      @foreach ($researchstudydocuments as $item)
