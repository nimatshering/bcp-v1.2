...
<div class="container py-4 px-6 mx-auto">
  <nav class="bg-gray-100 p-2 rounded font-sans w-full mb-2">
    <ol class="list-reset flex text-grey-dark">
      ...
      <li class="font-bold">Program & Project Documents</li>
    </ol>
  </nav>
    <!--Session message -->
  ...
  <div class="px-2 mt-2">
    <div class="flex justify-between">
        <div class="flex flex-col p-2 my-2 font-semibold uppercase">
          {{ \App\Models\Programprojectcategory::findOrFail($this->catID)->name }}
        </div>
    ...
    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        <table class="min-w-full divide-y divide-gray-200 table-auto">
            ...
            @foreach($projectdouments as $item)
    ...
    <!-- Add/Edit Modal -->
    @include('backend.livewire.agency.projectdocuments.partials._addModal')
      <!--Delete Modal -->
    @include('backend.livewire.agency.projectdocuments.partials._deleteModal')
  </div>
</div>
