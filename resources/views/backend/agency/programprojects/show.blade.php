  ...
  <div class="px-2 mt-2">
    <div class="flex justify-between items-center uppercase">
        ...
        <div class="p-2 my-2 font-semibold uppercase">
          <a href="{{ route('agency.programprojects.create')}}" class="px-4 py-2 rounded text-gray-50 uppercase text-xs font-bold focus:border-gray-200 bg-blue-500 hover:text-gray-200">
    ...
    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        <table class="min-w-full divide-y divide-gray-200 table-auto">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="flex justify-end gap-2 p-2">
                <a href="{{ route('agency.programprojects.edit', $item->id)}}" class="px-4 py-2 rounded text-gray-50 uppercase text-xs font-bold focus:border-gray-200 bg-gray-500 hover:text-gray-200">
                    Edit
                </a>                                     
      ...
      <!--Delete Modal -->
    {{-- @include('livewire.agency.partials._deleteModal') --}}
  </div>
</div>
