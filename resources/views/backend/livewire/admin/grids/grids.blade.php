    ...
    <div class="mx-auto sm:px-6 lg:px-8 mt-6">
      <div class="flex justify-between">
          <div class="flex flex-col my-2">
            <h3 class="text-lg font-medium text-gray-900"> Grids</h3>
          </div>
      ...
      <div class="flex flex-col">
        ...
        <!-- Add/Edit Modal -->
        @include('backend.livewire.admin.grids.partials._addModal')
         <!--Delete Modal -->
        @include('backend.livewire.admin.grids.partials._deleteModal')
    </div>
</div>
