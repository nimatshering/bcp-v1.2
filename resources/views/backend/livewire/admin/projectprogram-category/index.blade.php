  ...
  <nav class="bg-gray-50 p-3 font-sans w-full mt-2">
    <ol class="list-reset flex text-grey-dark text-xs uppercase pl-4">
      ...
      <li>Projects & Programs Category</li>
    </ol>
  </nav>
    ...
    <div class="mx-auto sm:px-6 lg:px-8 mt-6">
      ...
      <div class="flex flex-col">
        ...
        <!-- Add/Edit Modal -->
        @include('backend.livewire.admin.projectprogram-category.partials._addModal')
         <!--Delete Modal -->
        @include('backend.livewire.admin.projectprogram-category.partials._deleteModal')
    </div>
</div>
