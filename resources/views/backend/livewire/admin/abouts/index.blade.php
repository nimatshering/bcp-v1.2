            ...
            <table class="min-w-full divide-y divide-gray-200 table-auto">
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="flex justify-end gap-2 p-2">
                  <button wire:click="showEditModal({{ $item->id }})" class="p-4 rounded text-gray-50 uppercase text-xs font-bold focus:border-gray-200 bg-gray-500 hover:text-gray-200">
                      Edit
                  </button>                                    
                </td>
                </tr>
