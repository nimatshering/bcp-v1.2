  ...
  <nav class="bg-gray-50 p-3 font-sans w-full mt-2">
    ...
    <div class="sm:px-6 lg:px-8 mt-6 mb-20 mx-20">
      ...
      <div class="flex flex-col ">
            ...
            <table class="min-w-full divide-y divide-gray-200 table-auto">
              <thead class="bg-gray-100">
                <tr class="text-gray-800 text-xs font-semibold uppercase">
                  <th class="px-6 py-4 text-left tracking-wider"> </th>
                  <th class="px-6 py-4 text-left tracking-wider">ID</th>
                  <th class="px-6 py-4 text-left tracking-wider">Name</th>
        ...
        <!-- Add/Edit Modal -->
         @include('backend.livewire.admin.disaster-parameter.partials._addModal')
         <!--Delete Modal -->
        @include('backend.livewire.admin.disaster-parameter.partials._deleteModal')
    </div>
</div>
