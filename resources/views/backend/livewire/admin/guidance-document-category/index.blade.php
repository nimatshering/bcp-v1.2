  ...
  <nav class="bg-gray-50 p-3 font-sans w-full mt-2">
    <ol class="list-reset flex text-grey-dark text-xs uppercase pl-4">
      ...
      <li><a href="{{ route('admin.guidance.category') }}" class="text-blue font-bold">Guidance Document Category</a></li>
      <li><span class="mx-2">/</span></li>
      <li>Guidance Document Sub category</li>
    </ol>
  </nav>
    ...
    <div class="mx-auto sm:px-6 lg:px-8 mt-6">
      <div class="flex justify-between">
          <div class="flex flex-col p-2 my-2 font-semibold text-xl">
           {{ App\Models\Guidancecategory:: find($this->cat_id)->first()->name }}
          </div>
      ...
      <div class="flex flex-col">
        ...
        <!-- Add/Edit Modal -->
        @include('backend.livewire.admin.guidance-document-category.partials._addModal')
         <!--Delete Modal -->
        @include('backend.livewire.admin.guidance-document-category.partials._deleteModal')
    </div>
</div>
