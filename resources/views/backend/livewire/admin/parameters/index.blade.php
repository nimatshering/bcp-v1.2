    ...
    <div class="mx-auto sm:px-6 lg:px-8 mt-6">
      <div class="flex justify-between">
          <div class="flex flex-col my-2">
            <h3 class="text-lg font-medium text-gray-900"> Parameter</h3>
          </div>
      ...
      <div class="flex flex-col">
                    ...
                    <tr class="hover:bg-gray-50">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                          <div class="text-sm text-gray-900">
                              {!! App\Models\StationType::findOrFail($item->station_type_id)->name; !!}
                          </div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
                          <div class="text-sm text-gray-900">
        ...
        <!-- Add/Edit Modal -->
        @include('backend.livewire.admin.parameters.partials._addModal')
         <!--Delete Modal -->
        @include('backend.livewire.admin.parameters.partials._deleteModal')
    </div>
</div>
