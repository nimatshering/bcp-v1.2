...
<div class="container py-4 mx-auto px-20">
    ...
    <div class="mx-auto sm:px-6 lg:px-8">
      ...
      <x-jet-dialog-modal wire:model="confirmItemAdd">
          <x-slot name="title">
              {{ isset( $this->climatescenerio->id) ? 'Edit Climate Scenerio' : 'Add Climate Scenerio' }}
          </x-slot>
          ...
          <x-slot name="content">
              ...
              <div class="mt-4">
                  <div class="col-span-6 sm:col-span-4">
                      ...
                      <x-jet-input id="name" type="text" class="mt-1 block w-full" wire:model.defer="climatescenerio.name" />
                      <x-jet-input-error for="climatescenerio.name" class="mt-2" />
                  </div>
              </div>
                ...
                <div class="mt-4">
                  <div class="col-span-6 sm:col-span-4">
                      ...
                      <x-jet-input id="remarks" type="text" class="mt-1 block w-full" wire:model.defer="climatescenerio.remarks" />
                      <x-jet-input-error for="climatescenerio.remarks" class="mt-2" />
                  </div>
              </div>
