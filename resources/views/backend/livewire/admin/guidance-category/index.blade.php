              ...
              <table class="min-w-full divide-y divide-gray-200 table-auto">
                      ...
                      <div class="flex items-center">
                        <div class="ml-4 text-sm font-medium text-gray-900">
                          ...
                          <a href='{{ route('admin.guidancedocument.category', $item->id)}}' class ="px-4 py-2 bg-green-400 rounded">
                            <i class="fa fa-cubes pr-2"></i><span class="text-xs">{{ $item->subcategory->count()}}</span>
                          </a>
                        </td>
