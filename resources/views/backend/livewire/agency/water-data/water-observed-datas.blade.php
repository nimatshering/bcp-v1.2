...
<div class="container py-4 mx-auto px-20">
    ...
    <div class="p-3 rounded font-sans w-full m-4">
      @include('backend.livewire.agency.water-data.partials._waterObservedExcelUpload')
    </div>
          ...
          <x-slot name="content">
                ...
                <div class="mt-4">
                  ...
                  <x-jet-label for="station_id" value="{{ __('Select Station') }}" />
                    <select wire:model.defer="data.station_id" id="station_id" type="text" class="mt-1 block w-full">
                ...
                <div class="mt-4">
                  ...
                  <x-jet-label for="parameter_id" value="{{ __('Select Parameter') }}" />
                    <select wire:model.defer="data.parameter_id" id="parameter_id" type="text" class="mt-1 block w-full">
