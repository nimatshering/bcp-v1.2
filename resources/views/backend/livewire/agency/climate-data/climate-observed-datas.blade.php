...
<div class="container py-4 mx-auto px-20">
    ...
    <div class="p-3 rounded font-sans w-full m-4">
      @include('backend.livewire.agency.climate-data.partials._climateExcelUpload')
    </div>
          ...
          <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              ...
              <table class="min-w-full divide-y divide-gray-200 table-auto">
                      ...
                      <tr class="text-gray-800 text-xs font-semibold uppercase">
                          ...
                          <th scope="col" class="px-6 py-4 text-left tracking-wider hover:bg-blue-200" wire:click="sortData()" onfocus=""> 
                              Date of Reading
                          </th>
                              ...
                              <div class="ml-4">
                                  <div class="text-sm font-medium text-gray-900">
                                      <label class="inline-flex items-center">
                                          <input type="checkbox" class="form-checkbox text-gray-600" wire:model="selectedDatas" values="{{ $item->id }}">
                                      </label>
                                  </div>
                              </div>
                              </div>
