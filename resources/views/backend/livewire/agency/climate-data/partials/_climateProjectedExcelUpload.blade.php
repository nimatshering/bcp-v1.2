 ...
 <div class="flex w-full">
   <form action="{{ route('agency.climate.projected.xls.import') }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<div class="flex flex-1 bg-green-700 hover:bg-green-600 px-4 py-2 rounded my-2 w-4/12 text-white font-bold text-xs uppercase">
        <a href="/uploads/dataImportFiles/template_climate_projected.xlsx" >Download Format for life import</a>
</div>