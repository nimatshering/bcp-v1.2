...
<div class="container py-4 mx-auto px-20">
    ...
    <div class="mx-auto sm:px-6 lg:px-8">
      ...
      <x-jet-dialog-modal wire:model="confirmItemAdd">
          <x-slot name="title">
              {{ isset( $this->frame->id) ? 'Edit Time Frame' : 'Add Time Frame' }}
          </x-slot>
          ...
          <x-slot name="content">
              ...
              <div class="mt-4">
                  <div class="col-span-6 sm:col-span-4">
                      ...
                      <x-jet-input id="name" type="text" class="mt-1 block w-full" wire:model.defer="frame.name" />
                      <x-jet-input-error for="frame.name" class="mt-2" />
                  </div>
              </div>
              ...
              <div class="mt-4">
                  <div class="col-span-6 sm:col-span-4">
                      ...
                      <x-jet-input id="description" type="text" class="mt-1 block w-full" wire:model.defer="frame.description" />
                      <x-jet-input-error for="frame.description" class="mt-2" />
                  </div>
              </div>
