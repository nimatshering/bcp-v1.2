...
<div class="container py-4 mx-auto px-20">
    ...
    <ol class="list-reset flex text-grey-dark">
      <li><a href="{{ route('admin.dashboard') }}" class="text-blue">Home</a></li>
      <li><span class="mx-2">/</span></li>
      <li class="font-bold">Guidance Documents</li>
    </ol>
  </nav>
    ...
    <div class="mx-auto sm:px-6 lg:px-8">
      <div class="flex justify-between">
          <div class="flex flex-col p-2 my-2 font-semibold uppercase">
            {{ \App\Models\Guidancedocumentcategory::findOrFail($this->catID)->name }}
          </div>
      ...
      <div class="flex flex-col">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <table class="min-w-full divide-y divide-gray-200 table-auto">
              ...
              @foreach($guidancedocuments as $item)
        ...
        <!-- Add/Edit Modal -->
        @include('backend.livewire.agency.guidance-documents.partials._addModal')
         <!--Delete Modal -->
        @include('backend.livewire.agency.guidance-documents.partials._deleteModal')
    </div>
</div>
