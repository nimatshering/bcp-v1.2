...
<div class="container py-4 mx-auto px-20">
    ...
    <div class="mx-auto sm:px-6 lg:px-8">
      <div class="flex justify-between">
          <div class="flex flex-col p-2 my-2 font-semibold text-xl uppercase">Events
          </div>
      ...
      <div class="flex flex-col">
        ...
        <!-- Add/Edit Modal -->
        @include('backend.livewire.agency.events.partials._addModal')
         <!--Delete Modal -->
        @include('backend.livewire.agency.events.partials._deleteModal')
    </div>
</div>
