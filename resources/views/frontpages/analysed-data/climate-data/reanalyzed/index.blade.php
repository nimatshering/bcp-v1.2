<x-guest-layout>
    ...
    <section class="container mx-auto bg-white min-h-screen">
       <div class="flex flex-wrap text-sm font-bold leading-8 tracking-tight justify-center py-10 uppercase gap-2 mx-2 md:mx-0">
        <a href="{{ route('report.climate_observed') }}" class="shrink px-6 py-1 bg-gray-200 hover:bg-green-500 hover:text-white rounded shadow text-gray-700 w-full md:w-3/12 mx-2 md:mx-0">
              Observed Climate Data
        </a>
        <a href="{{ route('report.climate_projected') }}" class="shrink px-6 py-1 bg-gray-200 hover:bg-green-500 hover:text-white rounded shadow text-gray-700 w-full md:w-3/12 mx-2 md:mx-0">
              Projected Climate Data
        </a>
        <a href="{{ route('report.climate_reanalyzed') }}" class="shrink px-6 py-1 bg-green-600 hover:bg-green-500 rounded shadow text-gray-50 w-full md:w-3/12 mx-2 md:mx-0">
      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full md:w-9/12 px-4 mr-auto ml-auto">
          <div class="border border-gray-300 p-6 bg-white shadow rounded-lg my-4 md:my-0">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-2 p-2">
              <select name ="grid" id="grid" class="form-control">
                <option>Choose a Grid Number</option>
             ...
             <!-- Start Year -->
              ...
              @livewire('reports.climate-reanalyzed-report')
...
@push('scripts')
     @include('frontpages.analysed-data.climate-data.reanalyzed._drawChart')
@endpush
